# Create proposals directory if it does not exist
...
# File path
$file = "$dir/guidance_layer_design_principles.md"
...
• What to do if retaliation begins
...
Write-Host "Document created at $file"