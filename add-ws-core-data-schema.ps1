Write-Host "Creating ws-core data schema documentation..."

$path = "documentation/development/ws-core/ws-core-data-schema.md"

New-Item -ItemType Directory -Force -Path "documentation/development/ws-core" | Out-Null
...
Write-Host "Adding schema to git..."

git add $path

Write-Host "Creating commit..."

git commit -m "Add ws-core data schema documentation"

Write-Host "Pushing to GitHub..."

git push

Write-Host "ws-core data schema added."