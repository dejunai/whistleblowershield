...
add_action( 'save_post_ws-legal-update', 'ws_invalidate_legal_updates_sitewide_cache' );
add_action( 'before_delete_post', 'ws_invalidate_legal_updates_cache_on_delete' );

/**
 * Clears the sitewide legal updates transient after legal-update saves.
 *
 * @return void
 */
function ws_invalidate_legal_updates_sitewide_cache() {
    delete_transient( WS_CACHE_LEGAL_UPDATES_SITEWIDE );
}

/**
 * Clears the sitewide legal updates transient when a legal-update is deleted.
 *
 * @param int $post_id Candidate post ID being deleted.
 * @return void
 */
function ws_invalidate_legal_updates_cache_on_delete( $post_id ) {
...
add_action( 'save_post_jurisdiction', 'ws_handle_jurisdiction_save_cache_invalidation' );

/**
 * Clears jurisdiction/index caches and refreshes per-post term mapping.
 *
 * @param int $post_id Jurisdiction post ID being saved.
 * @return void
 */
function ws_handle_jurisdiction_save_cache_invalidation( $post_id ) {
...
add_action( 'before_delete_post', 'ws_invalidate_jurisdiction_caches_on_summary_delete' );

/**
 * Clears jurisdiction/index caches when a jx-summary is deleted.
 *
 * @param int $post_id Candidate post ID being deleted.
 * @return void
 */
function ws_invalidate_jurisdiction_caches_on_summary_delete( $post_id ) {
