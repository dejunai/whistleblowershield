...
function ws_register_acf_jx_interpretations() {
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [
                'key'           => 'field_ws_interp_has_plain_english',
            ...
            [
                'key'               => 'field_ws_interp_plain_english',
                ...
                'media_upload'      => 0,
                'conditional_logic' => [ [ [
                    'field'    => 'field_ws_interp_has_plain_english',
                    'operator' => '==',
                    'value'    => '1',
                ] ] ],
            ],
            [
                'key'           => 'field_ws_interp_plain_reviewed',
            ...
            [
                'key'           => 'field_ws_interp_summarized_by',
                'label'         => 'Summarized By',
                'name'          => 'summarized_by',
                'type'          => 'user',
            ...
            [
                'key'          => 'field_ws_interp_summarized_date',
